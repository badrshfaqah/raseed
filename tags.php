 ...
 *
 * التاق يمثّل شخصاً أو جهة تتعامل معها: المبالغ الواردة له (إيرادات
 * بتاقه) مقابل ما يُصرف/يُحوَّل له (مصروفات بتاقه)، وتعرض هذه الصفحة لكل
 * تاق المتبقّي له أو عليه للمحاسبة. مبالغ التاق جزء من الرصيد العام.
 */
